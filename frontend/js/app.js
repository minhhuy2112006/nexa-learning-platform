...
const views = {
  ...
  library: () => `
    <section class="product-view library-dashboard">
      <div class="library-main-column"><header class="library-header"><div class="library-heading"><p class="view-kicker">LEARNING LIBRARY</p><h1>My Library <span class="library-heading-mark">✦</span></h1><p>Your learning collection in one place.</p></div><section class="library-toolbar" aria-label="Library controls"><label class="library-search"><span>⌕</span><input type="search" aria-label="Search library" placeholder="Search library..." /></label><div class="library-refine-controls"><button class="library-select" type="button"><span>⌄</span>Type</button><button class="library-select" type="button"><span>⌄</span>Subject</button><button class="library-select" type="button"><span>⌄</span>Semester</button><button class="library-select" type="button"><span>⌄</span>Newest</button></div></section><nav class="library-type-filters" aria-label="Filter library by type"><button class="active" type="button" data-library-filter="all">All</button><button type="button" data-library-filter="textbook">Textbooks</button><button type="button" data-library-filter="material">Materials</button><button type="button" data-library-filter="saved">Saved</button><button type="button" data-library-filter="note">Notes</button></nav></header><section class="library-scroll-area" aria-label="Library resources"><div class="library-grid-heading"><b>All Resources <small>268 items</small></b></div><section class="library-resource-grid" aria-label="Learning resources">
          <article class="library-resource-card" data-kind="textbook" data-course="database" data-search="database systems concepts design textbook pdf"><div class="resource-card-actions"><button type="button" title="More options" aria-label="More options">•••</button><button type="button" data-library-remove-resource title="Remove resource" aria-label="Remove resource">×</button></div><i class="resource-cover database cover-image"><img src="assets/images/library-database-systems.png" alt="Database Systems: Concepts and Design cover" /></i><div class="resource-copy"><b>Database Systems: Concepts and Design</b><small>CS302 · Textbook</small><div class="resource-caption"><span>Chapter 3 of 12 · Read today</span><p class="resource-file">PDF · 8.4 MB <span>Purchased 12 May 2025</span></p></div><div class="resource-progress"><i><em style="width:72%"></em></i><b>72% complete</b></div></div><footer><button data-route="textbook">Continue reading <span>→</span></button><button type="button" data-library-save title="Save book" aria-label="Save book"><svg class="library-save-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.25 3.5h9.5c.69 0 1.25.56 1.25 1.25v15.7L12 17.02l-5.25 3.43V4.75c0-.69.56-1.25 1.25-1.25Z"/><path d="M10 8.1h4"/></svg></button><button type="button" title="Download PDF" aria-label="Download PDF">⇩</button></footer></article>
          <article class="library-resource-card" data-kind="textbook" data-course="data-structures" data-search="data structures algorithms python textbook pdf"><div class="resource-card-actions"><button type="button" title="More options" aria-label="More options">•••</button><button type="button" data-library-remove-resource title="Remove resource" aria-label="Remove resource">×</button></div><i class="resource-cover structures cover-image"><img src="assets/images/library-data-structures.png" alt="Data Structures and Algorithms in Python cover" /></i><div class="resource-copy"><b>Data Structures & Algorithms in Python</b><small>CS201 · Textbook</small><div class="resource-caption"><span>Chapter 5 of 14 · Read 2 days ago</span><p class="resource-file">PDF · 11.2 MB <span>Purchased 20 Apr 2025</span></p></div><div class="resource-progress"><i><em style="width:48%"></em></i><b>48% complete</b></div></div><footer><button data-route="textbook">Continue reading <span>→</span></button><button type="button" data-library-save title="Save book" aria-label="Save book"><svg class="library-save-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.25 3.5h9.5c.69 0 1.25.56 1.25 1.25v15.7L12 17.02l-5.25 3.43V4.75c0-.69.56-1.25 1.25-1.25Z"/><path d="M10 8.1h4"/></svg></button><button type="button" title="Download PDF" aria-label="Download PDF">⇩</button></footer></article>
          <article class="library-resource-card" data-kind="material" data-course="database" data-search="sql practice sheet set 3 material pdf"><div class="resource-card-actions"><button type="button" title="More options" aria-label="More options">•••</button><button type="button" data-library-remove-resource title="Remove resource" aria-label="Remove resource">×</button></div><i class="resource-cover sheet cover-image"><img src="assets/images/library-sql-practice.png" alt="SQL Practice Sheet Set 3 cover" /></i><div class="resource-copy"><b>SQL Practice Sheet · Set 3</b><small>CS302 · Practice material</small><div class="resource-caption"><span>24 exercises · Completed 14 May</span><p class="resource-file">PDF · 1.8 MB <span>Added 10 May 2025</span></p></div><div class="resource-progress resource-finished"><b>✓ Finished</b></div></div><footer><button data-route="practice">Open material <span>→</span></button><button type="button" data-library-save title="Save material" aria-label="Save material"><svg class="library-save-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.25 3.5h9.5c.69 0 1.25.56 1.25 1.25v15.7L12 17.02l-5.25 3.43V4.75c0-.69.56-1.25 1.25-1.25Z"/><path d="M10 8.1h4"/></svg></button><button type="button" title="Download PDF" aria-label="Download PDF">⇩</button></footer></article>
          <article class="library-resource-card" data-kind="saved" data-course="database" data-search="indexing techniques database systems article saved"><div class="resource-card-actions"><button type="button" title="More options" aria-label="More options">•••</button><button type="button" data-library-remove-resource title="Remove resource" aria-label="Remove resource">×</button></div><i class="resource-cover article cover-image"><img src="assets/images/library-indexing.png" alt="Indexing Techniques in Database Systems cover" /></i><div class="resource-copy"><b>Indexing Techniques in Database Systems</b><small>CS302 · Saved article</small><div class="resource-caption resource-article-caption"><span>Saved 15 May 2025</span><p class="resource-file">WEB ARTICLE <span>3 min read</span></p></div></div><footer><button type="button">Open article <span>→</span></button><button class="is-saved" type="button" data-library-save title="Saved" aria-label="Saved"><svg class="library-save-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.25 3.5h9.5c.69 0 1.25.56 1.25 1.25v15.7L12 17.02l-5.25 3.43V4.75c0-.69.56-1.25 1.25-1.25Z"/><path d="M10 8.1h4"/></svg></button><button type="button" title="Download article" aria-label="Download article">⇩</button></footer></article>
          <article class="library-resource-card" data-kind="material" data-course="database" data-search="normalization dbms slides lecture pptx"><div class="resource-card-actions"><button type="button" title="More options" aria-label="More options">•••</button><button type="button" data-library-remove-resource title="Remove resource" aria-label="Remove resource">×</button></div><i class="resource-cover lecture cover-image"><img src="assets/images/library-normalization.png" alt="Normalization in DBMS cover" /></i><div class="resource-copy"><b>Normalization in DBMS</b><small>CS302 · Slide deck</small><div class="resource-caption"><span>18 of 28 slides · Last opened today</span><p class="resource-file">PPTX · 4.6 MB <span>Added 08 May 2025</span></p></div><div class="resource-progress"><i><em style="width:65%"></em></i><b>65% complete</b></div></div><footer><button data-route="textbook">Open slides <span>→</span></button><button type="button" data-library-save title="Save slides" aria-label="Save slides"><svg class="library-save-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.25 3.5h9.5c.69 0 1.25.56 1.25 1.25v15.7L12 17.02l-5.25 3.43V4.75c0-.69.56-1.25 1.25-1.25Z"/><path d="M10 8.1h4"/></svg></button><button type="button" title="Download PPTX" aria-label="Download PPTX">⇩</button></footer></article>
          <article class="library-resource-card" data-kind="note" data-course="database" data-search="dbms notes collection"><div class="resource-card-actions"><button type="button" title="More options" aria-label="More options">•••</button><button type="button" data-library-remove-resource title="Remove resource" aria-label="Remove resource">×</button></div><i class="resource-cover notes cover-image"><img src="assets/images/library-dbms-notes.png" alt="DBMS Notes Collection cover" /></i><div class="resource-copy"><b>DBMS Notes Collection</b><small>CS302 · Personal notes</small><div class="resource-caption resource-note-caption"><span>12 notes · Updated today</span><p class="resource-file">NOTES · 46 KB <span>Created 10 May 2025</span></p></div></div><footer><button data-route="textbook">Open notes <span>→</span></button><button class="is-saved" type="button" data-library-save title="Saved" aria-label="Saved"><svg class="library-save-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.25 3.5h9.5c.69 0 1.25.56 1.25 1.25v15.7L12 17.02l-5.25 3.43V4.75c0-.69.56-1.25 1.25-1.25Z"/><path d="M10 8.1h4"/></svg></button><button type="button" title="Export notes" aria-label="Export notes">⇩</button></footer></article>
          <article class="library-resource-card" data-kind="material" data-course="analytics" data-search="business analytics dashboard workbook xlsx"><div class="resource-card-actions"><button type="button" title="More options" aria-label="More options">•••</button><button type="button" data-library-remove-resource title="Remove resource" aria-label="Remove resource">×</button></div><i class="resource-cover analytics">BUSINESS<br />ANALYTICS<small>Dashboard Workbook</small></i><div class="resource-copy"><b>Business Analytics Dashboard Workbook</b><small>BA204 · Workbook</small><div class="resource-caption"><span>Module 1 of 6 · Not started</span><p class="resource-file">XLSX · 2.2 MB <span>Purchased 02 May 2025</span></p></div><div class="resource-progress"><i><em style="width:18%"></em></i><b>18% complete</b></div></div><footer><button type="button">Open workbook <span>→</span></button><button type="button" data-library-save title="Save workbook" aria-label="Save workbook"><svg class="library-save-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.25 3.5h9.5c.69 0 1.25.56 1.25 1.25v15.7L12 17.02l-5.25 3.43V4.75c0-.69.56-1.25 1.25-1.25Z"/><path d="M10 8.1h4"/></svg></button><button type="button" title="Download XLSX" aria-label="Download XLSX">⇩</button></footer></article>
          <article class="library-resource-card" data-kind="note" data-course="analytics" data-search="data storytelling notes collection"><div class="resource-card-actions"><button type="button" title="More options" aria-label="More options">•••</button><button type="button" data-library-remove-resource title="Remove resource" aria-label="Remove resource">×</button></div><i class="resource-cover storytelling">DATA<br />STORY<small>Notes</small></i><div class="resource-copy"><b>Data Storytelling Notes</b><small>BA204 · Personal notes</small><div class="resource-caption resource-note-caption"><span>8 notes · Updated 13 May</span><p class="resource-file">NOTES · 31 KB <span>Created 06 May 2025</span></p></div></div><footer><button type="button">Open notes <span>→</span></button><button class="is-saved" type="button" data-library-save title="Saved" aria-label="Saved"><svg class="library-save-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.25 3.5h9.5c.69 0 1.25.56 1.25 1.25v15.7L12 17.02l-5.25 3.43V4.75c0-.69.56-1.25 1.25-1.25Z"/><path d="M10 8.1h4"/></svg></button><button type="button" title="Export notes" aria-label="Export notes">⇩</button></footer></article>
        </section><p class="library-empty" hidden>No resources match the selected filters.</p></section><footer class="library-pagination" aria-label="Library pagination"><button type="button" data-library-previous>← Previous</button><span><button class="active" type="button" data-library-page="1">1</button><button type="button" data-library-page="2">2</button></span><button type="button" data-library-next>Next →</button></footer></div><aside class="library-side-panel"><section class="library-notes-panel"><header><h2>Recent notes</h2><button type="button">View all</button></header><button type="button"><i></i><span><b>Normalization Summary</b><small>CS302 · Updated today</small></span></button><button type="button"><i></i><span><b>Query Optimization</b><small>CS302 · 2h ago</small></span></button></section><section class="library-storage-panel"><header><b>Storage</b><span>72% used</span></header><i><em style="width:72%"></em></i><small>7.2 GB / 10 GB</small><button type="button">Manage storage <span>→</span></button></section><section class="library-upload-panel"><h2>Upload your own<br />materials</h2><p>Store and organize your learning resources.</p><div><span>PDF</span><span>PPTX</span><span>DOCX</span></div><button type="button">Upload files <span>→</span></button></section><section class="library-recent-panel"><header><h2>Recently added</h2><button type="button">View all</button></header><button type="button"><i>PDF</i><span><b>SQL Practice Sheet</b><small>Added 10 May</small></span></button><button type="button"><i>PPT</i><span><b>Normalization Slides</b><small>Added 08 May</small></span></button></section></aside></section>`,  'ai-study': () => `<section class="product-view ai-study"><p class="view-kicker">NEXA AI STUDY</p><h1>Hi Minh <span>👋</span></h1><p class="view-subtitle">What would you like to work on?</p><article class="ai-context"><i>✦</i><span>Context active: <b>Database Systems · Chapter 3 · your learning progress</b></span></article><div class="quick-actions"><button data-ai-action="Explain Topic">✦ Explain Topic</button><button data-ai-action="Summarize">≡ Summarize</button><button data-ai-action="Generate Quiz">? Generate Quiz</button><button data-ai-action="Create Flashcards">▣ Create Flashcards</button><button data-ai-action="Create Study Plan">↗ Create Study Plan</button><button data-ai-action="Find Weak Topics">◌ Find Weak Topics</button></div><div class="ai-composer"><input id="ai-question" value="Explain normalization." aria-label="Ask anything about your study" /><button class="btn btn-primary" data-route="ai-answer">Ask AI ↑</button></div></section>`,
...
function setupLibraryControls() {
  ...
  const storageKey = 'nexa-library-hidden-resources';
  const removedResources = new Set(JSON.parse(localStorage.getItem(storageKey) || '[]'));
  ...
  const pagination = host.querySelector('.library-pagination');
  const previous = host.querySelector('[data-library-previous]');
  const next = host.querySelector('[data-library-next]');
  const pageButtons = host.querySelectorAll('[data-library-page]');
  const pageSize = 6;
  let type = 'all';
  let page = 1;

  cards.forEach((card, index) => { card.dataset.libraryResource ||= `resource-${index + 1}`; });

  const update = () => {
    const query = search.value.trim().toLowerCase();
    const matches = cards.filter((card) => {
      const matchesType = type === 'all' || card.dataset.kind === type;
      const matchesResource = !removedResources.has(card.dataset.libraryResource);
      const matchesSearch = !query || card.dataset.search.includes(query);
      return matchesType && matchesResource && matchesSearch;
    });
    const pageCount = Math.max(1, Math.ceil(matches.length / pageSize));
    page = Math.min(page, pageCount);
    cards.forEach((card) => { card.hidden = !matches.includes(card); });
    matches.forEach((card, index) => { card.hidden = Math.floor(index / pageSize) + 1 !== page; });
    empty.hidden = matches.length !== 0;
    pagination.hidden = matches.length <= pageSize;
    previous.disabled = page === 1;
    next.disabled = page === pageCount;
    pageButtons.forEach((button) => {
      const value = Number(button.dataset.libraryPage);
      button.hidden = value > pageCount;
  ...
  previous.addEventListener('click', () => { page = Math.max(1, page - 1); update(); });
  next.addEventListener('click', () => { page += 1; update(); });
  pageButtons.forEach((button) => button.addEventListener('click', () => { page = Number(button.dataset.libraryPage); update(); }));
  host.querySelectorAll('[data-library-remove-resource]').forEach((button) => button.addEventListener('click', () => {
    const card = button.closest('.library-resource-card');
    const title = card.querySelector('.resource-copy > b').textContent.trim();
    if (!window.confirm(`Bạn có chắc muốn xoá “${title}” khỏi Library?`)) return;
    removedResources.add(card.dataset.libraryResource);
    localStorage.setItem(storageKey, JSON.stringify([...removedResources]));
    page = 1;
    update();
  }));
  host.querySelectorAll('.library-resource-card footer button:not([data-route])').forEach((button) => button.addEventListener('click', () => {
    if (button.matches('[data-library-save]')) button.classList.toggle('is-saved');
  }));
  update();
}
