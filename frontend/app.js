...
const views = {
  ...
  textbook: () => `<section class="product-view textbook-view"><div class="view-heading"><div><p class="view-kicker">DATABASE SYSTEMS · TEXTBOOK</p><h1>Fundamentals of Database Design</h1><p class="view-subtitle">Free preview · Chapter 3 of 12</p></div><button class="btn btn-secondary" data-route="course-detail">← Course</button></div><div class="reader-toolbar"><button>☰ Contents</button><label>⌕ <input placeholder="Search in book" /></label><span>Page 38–39 of 180</span><button>🔖 Bookmark</button></div><div class="book-spread"><article><small>CHAPTER 3</small><h2>Normalization</h2><p>Normalization organizes data to reduce redundancy and protect consistency. Start by identifying the facts each relation should represent.</p><div class="highlight">A well-designed relation stores one kind of fact.</div><p>First normal form requires each field to contain atomic values. This makes the data easier to query and maintain.</p><b>38</b></article><article><small>3.2 RELATIONAL DESIGN</small><h2>Functional dependencies</h2><p>A functional dependency describes how one attribute determines another attribute in a relation.</p><ul><li>Identify candidate keys</li><li>Separate repeating groups</li><li>Validate each dependency</li></ul><b>39</b></article></div><div class="reader-footer"><span>Reading progress <i><em></em></i> 21%</span><button class="btn btn-primary">Continue reading →</button></div></section>`,
...
Object.assign(views, {
  ...
  textbook: () => `<section class="product-view reader-view"><div class="reader-top"><button data-route="course-detail">← Back to Database Systems</button><span>⌕　◌　▣　◉　⚙</span></div><div class="dark-reader"><aside><h3>Contents</h3><b>3.1 Functional Dependencies</b><b>3.2 Normal Forms</b><button>3.2.1 First Normal Form (1NF)</button><button class="active">3.2.2 Second Normal Form (2NF)</button><button>3.2.3 Third Normal Form (3NF)</button><button>3.2.4 Boyce-Codd Normal Form (BCNF)</button><b>3.3 Decomposition</b><b>Exercises</b></aside><main><h1>3.2.2 Second Normal Form (2NF)</h1><p>A table is in 2NF if it is in 1NF and every non-key attribute is fully functionally dependent on the entire primary key.</p><h2>Example</h2><table><tr><th>StudentID</th><th>CourseID</th><th>StudentName</th><th>CourseName</th><th>Grade</th></tr><tr><td>S001</td><td>C001</td><td>Minh Anh</td><td>Database Systems</td><td>A</td></tr><tr><td>S001</td><td>C003</td><td>Minh Anh</td><td>Data Structures</td><td>A</td></tr><tr><td>S002</td><td>C001</td><td>Hoàng Nam</td><td>Database Systems</td><td>A</td></tr></table><p>In the above table, StudentName depends only on StudentID, and CourseName depends only on CourseID, so it is not in 2NF.</p></main></div><footer class="reader-controls">←　　68 / 312　　→ <span>100%⌄</span></footer></section>`,
});
